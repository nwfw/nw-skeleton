...
var MixinWrapperMethods  = {
    methods: {
         ...
         */
        formatFileSize: function(bytes, lesserUnits = 0, minUnit = 0, treshold = 0, floatValue = false, formatNumber = false, returnObject = false){
            return _appWrapper.getHelper('format').formatFileSize(bytes, lesserUnits, minUnit, treshold, floatValue, formatNumber, returnObject);
        },
